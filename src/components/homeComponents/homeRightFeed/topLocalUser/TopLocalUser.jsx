...
const TopLocalUser = () => {
    return (
        <div className='w-full mb-12 sm:mb-6 md:mb-2'>
            <h3 className='w-full mb-4 text-xl font-bold text-center' >Top Local Users of the week</h3 >
